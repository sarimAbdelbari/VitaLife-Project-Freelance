      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-3 sm:px-4 lg:px-6">
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            ...
            {/* Subtitle */}
            <motion.p
              className="text-md md:text-lg text-white/95 mb-6 max-w-2xl mx-auto leading-relaxed drop-shadow-md"
              variants={itemVariants}
            >
            ...
            >
              <motion.button
                className="px-6 py-3 bg-gradient-to-r cursor-pointer from-[#04B2D9] to-[#06B6D4] text-white font-semibold rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-pulse-glow border border-white/20"
              ...
              <motion.button
                className="px-6 py-3 bg-white/20 cursor-pointer backdrop-blur-sm text-white font-semibold rounded-lg border border-white/40 hover:bg-white/30 transition-all duration-300 shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => {
            ...
            >
              {[
                ...
                >
                  {stat.number && <div className="text-xl md:text-2xl font-bold text-white mb-1 drop-shadow-md">{stat.number}</div>}
                  <div className="text-md md:text-lg text-white/90">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
