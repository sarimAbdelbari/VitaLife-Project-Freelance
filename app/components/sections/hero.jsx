          ...
          >
            ...
            >
              <Image
                ...
                width={180}
                height={180}
                className="object-contain mt-1 mr-2 w-[140px] h-[140px] sm:w-[160px] sm:h-[160px] md:w-[180px] md:h-[180px] "
              />
            </motion.div>

            {/* Main Heading */}
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-2 sm:mb-3 md:mb-4 drop-shadow-lg"
              variants={itemVariants}
            >
              Votre Santé,
              <br />
            ...
            {/* Subtitle */}
            <motion.p
              className="text-sm sm:text-base md:text-lg text-white/95 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed drop-shadow-md"
              variants={itemVariants}
            >
            ...
            >
              {[
                ...
                <div
                  key={index}
                  className="px-2.5 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white/90 text-xs sm:text-sm md:text-base border border-white/30 shadow-md"
                >
                  {service}
                </div>
              ))}
            ...
            >
              <motion.button
                className="px-6 py-3 bg-gradient-to-r text-sm sm:text-base md:text-lg lg:text-xl cursor-pointer from-[#04B2D9] to-[#06B6D4] text-white font-semibold rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-pulse-glow border border-white/20"
              ...
              <motion.button
                className="px-6 py-3 text-sm sm:text-base md:text-lg lg:text-xl bg-white/20 cursor-pointer backdrop-blur-sm text-white font-semibold rounded-lg border border-white/40 hover:bg-white/30 transition-all duration-300 shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => {
            ...
            >
              {[
                ...
                >
                  {stat.number && <div className="text-sm sm:text-base md:text-xl lg:text-2xl font-bold text-white mb-0.5 sm:mb-1 drop-shadow-md">{stat.number}</div>}
                  <div className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
